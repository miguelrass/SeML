...
public class InternalSeMLLexer extends Lexer {
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSeML.g:864:12: ( RULE_INT '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) RULE_INT )? )
            // InternalSeML.g:864:14: RULE_INT '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) RULE_INT )?
            {
            mRULE_INT(); 
            match('.'); 
            // InternalSeML.g:864:27: ( '0' .. '9' )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
            ...
            // InternalSeML.g:864:39: ( ( 'e' | 'E' ) RULE_INT )?
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalSeML.g:864:40: ( 'e' | 'E' ) RULE_INT
                    {
    ...
    public final void mRULE_BOOL() throws RecognitionException {
        try {
            int _type = RULE_BOOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSeML.g:866:11: ( ( 'true' | 'false' ) )
            // InternalSeML.g:866:13: ( 'true' | 'false' )
            {
            // InternalSeML.g:866:13: ( 'true' | 'false' )
            int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSeML.g:868:10: ( ( '-' )? ( '0' .. '9' )+ )
            // InternalSeML.g:868:12: ( '-' )? ( '0' .. '9' )+
            {
            // InternalSeML.g:868:12: ( '-' )?
            int alt4=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSeML.g:870:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalSeML.g:870:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalSeML.g:870:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalSeML.g:870:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalSeML.g:870:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalSeML.g:870:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalSeML.g:870:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSeML.g:872:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalSeML.g:872:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalSeML.g:872:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSeML.g:874:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalSeML.g:874:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalSeML.g:874:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_ALIAS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSeML.g:876:12: ( ( '-' )? ( 'A' .. 'Z' | 'a' .. 'z' | '*' | '_' | '.' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '-' | '*' | '_' | '.' )* )
            // InternalSeML.g:876:14: ( '-' )? ( 'A' .. 'Z' | 'a' .. 'z' | '*' | '_' | '.' ) ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '-' | '*' | '_' | '.' )*
            {
            // InternalSeML.g:876:14: ( '-' )?
            int alt13=2;
            ...
            // InternalSeML.g:876:51: ( 'A' .. 'Z' | 'a' .. 'z' | '0' .. '9' | '-' | '*' | '_' | '.' )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSeML.g:878:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalSeML.g:878:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalSeML.g:878:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSeML.g:880:16: ( . )
            // InternalSeML.g:880:18: .
            {
            matchAny(); 

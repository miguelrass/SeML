...
class RestrictionVisitor {
        ...
        private List<OWLClassExpression> Restrictions;

        RestrictionVisitor(OWLOntology ont) {
            processedClasses = new HashSet<OWLClass>();
            Restrictions = new ArrayList<OWLClassExpression>();
            this.ont = ont;
        }
        
        public List<OWLClassExpression> getRestrictions(){
        	return Restrictions;
        }

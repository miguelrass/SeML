...
public class ClassSolver implements OWLClassExpressionVisitor {
	...
	private static final String local_log = "Class Solver Log: ";
	/**
    ...
    public void visit(@Nonnull OWLObjectComplementOf owlObjectComplementOf) {
    	System.err.println("Error: Complement not supported: " + owlObjectComplementOf);
    }
    ...
    //======================================================================== Anonymous Classes
    //(these can only be used to link existing individuals, not creating new ones)
    @Override public void visit(@Nonnull OWLObjectSomeValuesFrom owlObjectSomeValuesFrom) {} 
